...
(function ageConfirmation() {
  ...
  try { const saved = JSON.parse(localStorage.getItem('ayla.age_gate_confirmed_v1')); confirmed = confirmed || (saved?.accepted === true && Number.isFinite(saved.acceptedAt)); } catch (_) {}
  if (confirmed) enter();
